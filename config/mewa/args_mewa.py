...
def get_args(rest_args):
    ...
    # ----- GENERAL -----
    # ------------------------------------------------------------------------------------------------------------------
    parser.add_argument('--exp_label', default='LaSER', help='label (typically name of method)')
    parser.add_argument('--env_name', default='MEWASymbolic-v0', help='environment to train on')

    # ------------------------------------------------------------------------------------------------------------------
    # ----- ENVIRONMENT PARAMETERS -----
    # ------------------------------------------------------------------------------------------------------------------
    parser.add_argument('--task', type=str, default='mewa/mewa_tasks/optimal.yaml', help='Path to MEWA task')
    parser.add_argument('--worker', type=str, default='complex', help='the type of worker: simple or complex')
    parser.add_argument('--wide', type=int, default=1)
    parser.add_argument('--narrow', type=int, default=3000)
    parser.add_argument('--split', default=None)
    parser.add_argument('--split_train', default=[[0], [0]])
    parser.add_argument('--split_eval', default=[[0], [0]])
    parser.add_argument('--uniform_human', type=boolean_argument, default=False)
    ...
    parser.add_argument('--lr_enc', type=float, default=3e-05, help='encoder learning rate (default: 3e-05)')
    parser.add_argument('--lr_policy_exploration', type=float, default=1e-05,
                        help='exploration policy learning rate (default: 3e-05)')
    parser.add_argument('--lr_policy_task', type=float, default=1e-04,
                        help='task policy learning rate (default: 1e-04)')
    parser.add_argument('--lr_critic_task', type=float, default=None,
                        help='task policy learning rate (default: 3e-05)')
    parser.add_argument('--pre_train_epochs', type=int, default=10000,
    ...
    parser.add_argument('--batches_pre_collect', type=int, default=0,
    ...
    # ----- TASK TRAINING -----
    # ------------------------------------------------------------------------------------------------------------------
    parser.add_argument('--task_train_epochs', type=int, default=10000)
    ...
    parser.add_argument('--save_train_tasks', type=boolean_argument, default=False,
                        help='save the meta-training task descriptions sampled during pre-training')
    parser.add_argument('--save_test_tasks', type=boolean_argument, default=False,
    ...
    parser.add_argument('--reconstruction_hidden_sizes', nargs='*', type=int, default=[])
    ...
    parser.add_argument('--policy_exp_anneal_lr', type=boolean_argument, default=False, help='anneal LR over time')
    parser.add_argument('--policy_task_anneal_lr', type=boolean_argument, default=True, help='anneal LR over time')
    ...
    # Task Policy
    parser.add_argument('--task_policy_gamma', type=float, default=0.99, help='discount factor for (task) rewards')
    parser.add_argument('--batches_task_collect', type=int, default=5,
                        help='how many batches of tasks to collect (per iteration) for training the task policy')
    parser.add_argument('--task_policy_activation_function', type=str, default='tanh',
                        help='tanh/relu/leaky-relu')
    parser.add_argument('--policy_context_activation_function', type=str, default='tanh',
    ...
    # FIXME Separate exploration and task normalizers
    ...
    # PPO specific
    parser.add_argument('--ppo_exp_num_epochs', type=int, default=4, help='number of epochs per PPO update')
    parser.add_argument('--ppo_exp_num_minibatch', type=int, default=2, help='number of minibatches to split the data')
    parser.add_argument('--ppo_task_num_epochs', type=int, default=4, help='number of epochs per PPO update')
    parser.add_argument('--ppo_task_num_minibatch', type=int, default=2, help='number of minibatches to split the data')
    ...
    parser.add_argument('--ppo_exp_clip_param', type=float, default=0.1, help='clamp param')
    parser.add_argument('--ppo_task_clip_param', type=float, default=0.2, help='clamp param')
    ...
    parser.add_argument('--ppo_task_pfo', type=boolean_argument, default=True, help='use PFO for task policy')
    ...
    # ------------------------------------------------------------------------------------------------------------------
    parser.add_argument('--policy_eps', type=float, default=1e-8, help='optimizer epsilon (1e-8 for ppo)')
    ...
    parser.add_argument('--policy_exp_pfo_coef', type=float, default=0.1, help='pfo term coefficient')
    parser.add_argument('--policy_task_pfo_coef', type=float, default=0.1, help='pfo term coefficient')
    ...
    # ------------------------------------------------------------------------------------------------------------------
    # ----- TASK POLICY META-ENTROPY -----
    # ------------------------------------------------------------------------------------------------------------------
    parser.add_argument('--use_meta_entropy', type=boolean_argument, default=True)
    parser.add_argument('--meta_entropy_loss', type=str, default='entropy',
                        help='Options: entropy (default), neg_log, kl_div')
    parser.add_argument('--meta_entropy_coeff', type=float, default=0.05)
    parser.add_argument('--meta_entropy_clip', type=float, default=-0.15)
    parser.add_argument('--meta_entropy_value_weight', type=str, default='tanh_diff',
                        help='how to create the value function weight. Options: tanh_diff (default), ratio, exp_diff')
    parser.add_argument('--meta_entropy_equation', type=str, default='default',
                        help='Options: default, entropy_only, weight_only')
    parser.add_argument('--meta_entropy_exp_coeff', type=float, default=1.0)
    parser.add_argument('--meta_entropy_mask_diff', type=boolean_argument, default=True)
    ...
    parser.add_argument('--dataset_output_folder', type=str, default='./datasets')
    parser.add_argument('--seed_dataset', type=int, default=int(np.random.choice(65536, replace=False, size=1)[0]))

    # ------------------------------------------------------------------------------------------------------------------
    # ----- ABLATIONS -----
    # ------------------------------------------------------------------------------------------------------------------
    parser.add_argument('--ablation_use_history', type=boolean_argument, default=False)
    ...
    parser.add_argument('--eval_interval', type=int, default=400, help='eval interval, one eval per n updates')
    parser.add_argument('--test_interval', type=int, default=-1, help='eval interval, one eval per n updates')
    parser.add_argument('--results_log_dir', default='./results/mewa',
                        help='directory to save results (None uses ./logs)')
    parser.add_argument('--eval_repeat_task', type=int, default=40)
    parser.add_argument('--eval_repeat_task_traj', type=int, default=10)
    parser.add_argument('--run_test', type=boolean_argument, default=True)
    ...
    parser.add_argument('--seed', nargs='+', type=int,
                        default=int(np.random.choice(65536, replace=False, size=1)[0]))
